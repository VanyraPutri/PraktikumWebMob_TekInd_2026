...
suhuMesin.addEventListener('mouseover', function() {
    this.style.fontWeight = 'bold';   // Membuat teks menjadi tebal
    this.style.color = 'blue';        // Mengubah warna menjadi biru
    this.style.cursor = 'pointer';    // Mengubah kursor menjadi tangan
});

// Event saat mouse keluar
suhuMesin.addEventListener('mouseout', function() {
    this.style.fontWeight = 'normal'; // Kembali ke teks normal
    if (suhu <= 80) {
        this.style.color = 'black';
    }
    this.style.cursor = 'default';    // Kembalikan kursor default
});